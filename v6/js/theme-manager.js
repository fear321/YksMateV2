...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const currentTheme = appearanceData.theme || savedTheme || 'special';
    ...
    function applyTheme(theme) {
        ...
        document.body.classList.remove('light-theme', 'dark-theme', 'special-theme');
